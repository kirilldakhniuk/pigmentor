...
$classes = Flux::classes()
    ...
    ->add('transition-all duration-150 ease-out active:scale-[0.97] active:duration-75')
    ->add(match ($align) {
        'start' => 'justify-start',
    ...
    ->add(match ($size) {
        ...
        'sm' => 'h-7 text-xs rounded-md' . ' ' . ($square ? 'w-7' : 'px-3'),
        'xs' => 'h-5 text-xs rounded' . ' ' . ($square ? 'w-5' : 'px-2'),
    })
    ->add('inline-flex')
    ...
    ->add(match ($variant) {
        'primary' => 'bg-gradient-to-b from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 dark:from-blue-600 dark:to-blue-700 dark:hover:from-blue-500 dark:hover:to-blue-600',
        'filled' => 'bg-zinc-100 hover:bg-zinc-200/80 dark:bg-white/10 dark:hover:bg-white/15',
        'outline' => 'bg-white/80 hover:bg-white dark:bg-zinc-800/80 dark:hover:bg-zinc-700/80',
        'danger' => 'bg-gradient-to-b from-red-500 to-red-600 hover:from-red-400 hover:to-red-500',
        'ghost' => 'bg-transparent hover:bg-zinc-500/10 dark:hover:bg-white/10',
        'subtle' => 'bg-transparent hover:bg-zinc-500/10 dark:hover:bg-white/10',
    })
    ->add(match ($variant) {
        'primary' => 'text-white',
        'filled' => 'text-zinc-700 dark:text-white',
        'outline' => 'text-zinc-700 dark:text-zinc-200',
        'danger' => 'text-white',
        'ghost' => 'text-zinc-600 dark:text-zinc-300',
        'subtle' => 'text-zinc-500 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-white',
    })
    ->add(match ($variant) {
        'primary' => 'ring-1 ring-inset ring-white/20',
        'outline' => 'ring-1 ring-inset ring-zinc-900/10 dark:ring-white/10',
        'danger' => 'ring-1 ring-inset ring-white/20',
        default => '',
    })
    ->add(match ($variant) {
        'primary' => 'shadow-sm shadow-blue-600/25',
        'danger' => 'shadow-sm shadow-red-600/25',
        'outline' => 'shadow-sm shadow-zinc-900/5 dark:shadow-none',
        default => '',
    })
    ->add(match ($variant) {
        'ghost' => '',
